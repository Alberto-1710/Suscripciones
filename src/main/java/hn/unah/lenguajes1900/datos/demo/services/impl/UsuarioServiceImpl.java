...
public class UsuarioServiceImpl implements UsuarioService{
    ...
    public Usuario actualizarUsuario(long id, Usuario usuario) {
        Usuario usuarioActualizar = this.usuarioRepository.findById(id).get(); //ir a recuperar la propiedad
    ...
    public String eliminarUsuario(long id) {
        Usuario eliminarUsuario = this.usuarioRepository.findById(id).get();

        if(null!=eliminarUsuario){
